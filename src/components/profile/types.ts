...
export const SET_FOLLOWING_LOADING = "PROFILE.SET_FOLLOWING_LOADING";
export const SET_FOLLOWERS_LOADING = "PROFILE.SET_FOLLOWERS_LOADING";
export const SET_STARS_LOADING = "PROFILE.SET_STARS_LOADING";
...
type ProfileActionTypeValue =
    ...
    | typeof SET_FOLLOWING_LOADING
    | typeof SET_FOLLOWERS_LOADING
    | typeof SET_STARS_LOADING;
